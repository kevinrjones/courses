...
namespace UnitTests.Route
{
    ...
    public class OutboundRoutingTests
    {
        ...
        [Test]
        public void GivenACorrectRoutesCollection_WhenIAskToCreateAUrlForABtodoListPageIndexView_ThenIGetTheCorrectUrl()
        {
        ...
        [Test]
        public void GivenACorrectRoutesCollection_WhenIAskToGenerateAUrlToCreateATodoItem_ThenIGetTheCorrectUrl()
        {
            Assert.AreEqual("/todo/create", GetOutboundUrl(new
            {
                controller = "Todo",
                action = "Create",
            }));
